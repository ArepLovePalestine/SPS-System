  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <footer className="bg-[#1a1a1a] text-white py-24 px-8 border-t border-gray-800">
        ...
        <div className="max-w-7xl mx-auto border-t border-gray-800/50 mt-20 pt-10 flex flex-col md:flex-row justify-between items-center text-[10px] tracking-widest uppercase font-bold text-gray-600">
